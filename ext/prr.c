...
ZEND_DECLARE_MODULE_GLOBALS(prr)
...
#ifndef ZEPHIR_RELEASE
static PHP_MSHUTDOWN_FUNCTION(prr)
{
 ...
 */
static void php_zephir_init_globals(zend_prr_globals *zephir_globals TSRMLS_DC)
{
...
static PHP_RINIT_FUNCTION(prr)
{

	zend_prr_globals *zephir_globals_ptr = ZEPHIR_VGLOBAL;
...
static PHP_MINFO_FUNCTION(prr)
{
	php_info_print_box_start(0);
	php_printf("%s", PHP_PRR_DESCRIPTION);
	php_info_print_box_end();

	php_info_print_table_start();
	php_info_print_table_header(2, PHP_PRR_NAME, "enabled");
	php_info_print_table_row(2, "Author", PHP_PRR_AUTHOR);
	php_info_print_table_row(2, "Version", PHP_PRR_VERSION);
	php_info_print_table_row(2, "Powered by Zephir", "Version " PHP_PRR_ZEPVERSION);
	php_info_print_table_end();


}

static PHP_GINIT_FUNCTION(prr)
{
	php_zephir_init_globals(prr_globals TSRMLS_CC);
}

static PHP_GSHUTDOWN_FUNCTION(prr)
{

}

zend_module_entry prr_module_entry = {
